...
% Changed to median instead of mean by me and updated functions 15/09/2023
...
amean = median(amatrix,1,"omitmissing"); %get man over first dimension
if smth > 1
    amean = boxFilter(median(amatrix,1),smth, "omitmissing"); %use boxfilter to smooth data
end
astd = std(amatrix,[],1,"omitmissing"); % to get std shading
